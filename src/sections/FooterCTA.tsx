    ...
    <section className="relative py-32 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <a
            href="#contact"
            className="w-32 h-32 bg-navy-light/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white text-sm font-medium text-center leading-tight hover:bg-accent hover:text-navy transition-all transform hover:scale-110 shadow-lg"
          >
            Get Your
            <br />
            Free Quote
