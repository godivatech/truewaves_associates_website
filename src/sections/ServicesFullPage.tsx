          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute left-0 w-full p-8 z-20 top-full -translate-y-full group-hover:top-1/2 group-hover:-translate-y-1/2 transition-all duration-700 ease-in-out">
                  <div className="flex flex-col transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out delay-75">
                    ...
                    <p className="text-white/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-150 text-sm leading-relaxed max-w-[280px]">
                      {service.description}
                    </p>
                  </div>
                </div>
