          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {contactInfo.map((item, index) => (
              ...
              >
                ...
                <p className="text-gray-500 mb-8 flex-1">{item.value}</p>
                <button className="w-full py-4 bg-azure text-navy rounded-full font-bold text-sm tracking-wide hover:opacity-90 transition-opacity mt-auto">
                  {item.buttonText}
                </button>
              </motion.div>
            ))}
